...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        #eval_davis
        #parser.add_argument('--model', default='/cluster/work/cvl/wengwang/zyr/211078937.tmpdir/saves/Mar25_18.48.08_retrain_s03/Mar25_18.48.08_retrain_s03_150000.pth')
        parser.add_argument('--davis_path', default='data/DAVIS/2017')
        parser.add_argument('--csv_path', default='output')
        parser.add_argument('--output', default = 'output')
        parser.add_argument('--ckpt_output', default = 'output')
        ...
        if self.args['stage'] == 0:
            ...
            self.args['lr'] = none_or_default(self.args['lr'], 5e-5)
